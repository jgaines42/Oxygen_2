...
print(all_steps[1200])

# Fit linear section to calculate diffusion coeficient
popt_linear, pcov_linear = scipy.optimize.curve_fit(linear, all_steps[fit_start:1200], data[fit_start:1200], p0=[8000.0, 0])
...
plt.plot([all_steps[fit_start],all_steps[1200]], [data[fit_start], data[1200]], 'x')
plt.axis([0, 5, 0, 8])
